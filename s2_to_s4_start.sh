...
bash /Users/binwu/OOR-local/katas/saleor/start_saleor/s3_start_dummy_payment_app.sh
...
bash /Users/binwu/OOR-local/katas/saleor/start_saleor/s4_start_ngrok.sh
